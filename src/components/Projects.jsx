  ...
  const projects = [
    {
      ...
      description:
        "A full-stack food ordering web application with real-time menu updates and order status tracking. Features seamless payment integration and state management.",
    ...
    },
    {
      title: "Job Tracker",
      description:
        "A MERN Stack Application designed to help users track job applications. Features include user authentication, job application management, and analytics dashboard.",
      technologies: [
        "React.js",
        "Mongo DB",
        "NodeJs",
    ...
    },
    {
      ...
      github: "https://github.com/DaveNrupal/mini-splitwiser",
      highlights: [
    ...
    },
    {
      ...
      description:
        "An IoT-based security monitoring system integrating ReactJS and IoT devices. Implemented API integrations for real-time data tracking and analysis with optimized front-end experience.",
